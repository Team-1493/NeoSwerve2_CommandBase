...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new Trigger(driverJoystick.pov90).whileTrue(m_swervedriveSystem.rotateInPlace(90));
    new Trigger(driverJoystick.pov180).whileTrue(m_swervedriveSystem.rotateInPlace(180));   
    new Trigger(driverJoystick.pov270).whileTrue(m_swervedriveSystem.rotateInPlace(-90));
